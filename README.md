...
`${GOPATH}/src/github.com/gdcrocx/pcapbeat`
...
```
git remote set-url origin https://github.com/gdcrocx/pcapbeat
...
```
mkdir -p ${GOPATH}/src/github.com/gdcrocx/pcapbeat
git clone https://github.com/gdcrocx/pcapbeat ${GOPATH}/src/github.com/gdcrocx/pcapbeat
```
